    ...
    class DBContext
    {
        ...
        public DBContext()
        {
            ...
            List<Product> products = new List<Product> {
                ...
                new Product("Tablet", "10-inch tablet with 64GB storage", 329.99, 20, Accounts[4] as Company),
                new Product("Monitor", "27-inch 4K UHD monitor", 349.99, 12, Accounts[0] as Company),
                new Product("Keyboard", "Mechanical RGB gaming keyboard", 99.99, 40, Accounts[6] as Company),
                ...
                new Product("Router", "Wi-Fi 6 router with extended range", 129.99, 18, Accounts[10] as Company),
                ...
                new Product("Bluetooth Speaker", "Portable waterproof Bluetooth speaker", 89.99, 28, Accounts[5] as Company),
                new Product("Fitness Tracker", "Fitness tracker with heart rate monitor", 59.99, 50, Accounts[2] as Company),
